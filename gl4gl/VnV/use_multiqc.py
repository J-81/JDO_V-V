...
def format_as_dataframe(mqc_rep: dict) -> pd.DataFrame:
    ...
    for mqc_module, single_module_data in zip(mqc_modules, mqc_rep.general_stats_data):
        print(mqc_module, single_module_data)
